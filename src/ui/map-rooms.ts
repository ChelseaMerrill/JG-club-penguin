...
export const MAP_ROOMS: readonly MapRoomTile[] = [
  ...
  { number: '07', label: '07 · TEAM ROOM 4', subtitle: 'THE POD · 350 SF', roomId: 'team-room-4' },
  { number: '08', label: '08 · TEAM ROOM 1', subtitle: 'AI LAB · 337 SF', roomId: 'team-room-1' },
  {
    number: '09',
    label: '09 · TEAM ROOM 2',
    subtitle: 'UX STUDIO · 292 SF',
    roomId: 'team-room-2',
  },
  {
    number: '10',
    label: '10 · TEAM ROOM 3',
    subtitle: 'DATA CAVE · 287 SF',
    roomId: 'team-room-3',
  },
  {
    number: '11',
